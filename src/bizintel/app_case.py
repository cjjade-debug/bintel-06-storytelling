...
Output:
- docs/images/storytelling_category_sales_cjjade.png
- docs/images/storytelling_monthly_sales_cjjade.png
...
REPORTING_FILE: Final[Path] = DATA_REPORTING / "sales_reporting_cjjade.csv"
...
STORYTELLING_CHART_FILE_1: Final[Path] = (
    CHARTS_OUTPUT / "storytelling_category_sales_cjjade.png"
)
STORYTELLING_CHART_FILE_2: Final[Path] = (
    CHARTS_OUTPUT / "storytelling_monthly_sales_cjjade.png"
)
